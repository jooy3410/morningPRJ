...
<%
	// Controller에서 model.addAttribute("res", String.valueOf(res)); 로부터 저장된 값 불러오기
	...
	// 웹 URL로부터 전달받는 값들(스프링은 기본적으로 포워드 방식으로 페이지를 이동하기때문에 url에 입력받은 request 값을 가져 올 수 있음, 일반적은 jsp에선 불가능함)
