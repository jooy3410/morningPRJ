...
public class MailController {
	...
	@RequestMapping(value="mail/post")
	public String post() {
	 ...
	 * 메일 발송하기
	 */
	@RequestMapping(value = "mail/sendMail", method = {RequestMethod.GET, RequestMethod.POST})
	public String sendMail(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		// 함수 처리가 끝나고 보여줄 JSP 파일명(/WEB-INF/view//mail/sendMailRequest.jsp)
